...
CSGOConfig.TeamCT = 1
CSGOConfig.TeamT = 2
CSGOConfig.TeamSpectator = TEAM_SPECTATOR

CSGOConfig.TeamOrder = { CSGOConfig.TeamCT, CSGOConfig.TeamT, CSGOConfig.TeamSpectator }

CSGOConfig.TeamNames = {
    [CSGOConfig.TeamCT] = "CT",
    [CSGOConfig.TeamT] = "T",
    [CSGOConfig.TeamSpectator] = "Spectators"
}

CSGOConfig.TeamColors = {
    [CSGOConfig.TeamCT] = Color(80, 140, 255),
    [CSGOConfig.TeamT] = Color(255, 90, 90),
    [CSGOConfig.TeamSpectator] = Color(150, 158, 172)
}
...
CSGOConfig.AbortDelay = 3
CSGOConfig.StartArmor = 100
CSGOConfig.MaxNameLength = 32
...
CSGOConfig.StopSpeed = 80
CSGOConfig.MaxVelocity = 3500
...
function CSGOConfig.IsSpectatorTeam(teamID)
    return teamID == CSGOConfig.TeamSpectator
end

function CSGOConfig.IsIdleTeam(teamID)
    return teamID == CSGOConfig.TeamSpectator or teamID == TEAM_UNASSIGNED
end
