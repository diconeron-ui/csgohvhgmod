...
local function UpdateSpectatorText(maxWidth)
    ...
    local shared = Shared()
    local spectators = shared and shared.GetSpectators() or {}
...
local function CreateBoard()
    ...
    local teamCT = CSGOConfig.TeamCT
    local teamT = CSGOConfig.TeamT
    ...
    ctList = CreateTeamColumn(board, margin, columnY, columnWidth, columnHeight, teamCT, "COUNTER-TERRORISTS", colors.ct)
    tList = CreateTeamColumn(board, margin + columnWidth + gap, columnY, columnWidth, columnHeight, teamT, "TERRORISTS", colors.t)
    ...
    board.Think = function()
        ...
        RefreshList(ctList, teamCT, colors.ct)
        RefreshList(tList, teamT, colors.t)
    end
